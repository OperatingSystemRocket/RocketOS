...
void kernel_main(void) {
    ...
    do { if(!(1==2)) { kprintf("%4[file: %s :: line: %i]: ", "src/kernel.c", 34); terminal_writestring_color("Condition Failed: ", VGA_COLOR_RED); terminal_writestring_color("1==2", VGA_COLOR_RED); terminal_putchar_color('\n', VGA_COLOR_RED); return; } } while(0);
