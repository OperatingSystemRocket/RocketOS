...
kernel_main:
	...
	movl	%esp, %ebp	/ ,
	subl	$8, %esp	/ ,
/  src/kernel.c:6:     terminal_initialize();
	call	terminal_initialize	/ 
/  src/kernel.c:8:     kprintf("Hello %c %i %s\n", 'c', 5, "Hello String");
	pushl	$.LC0	/ 
	pushl	$5	/ 
	pushl	$99	/ 
	pushl	$.LC1	/ 
	call	kprintf	/ 
/  src/kernel.c:9:     terminal_writestring("this is a test of scrolling\n");
	movl	$.LC2, (%esp)	/ ,
	call	terminal_writestring	/ 
/  src/kernel.c:13:     terminal_putchar_color('c', VGA_COLOR_CYAN);
	addl	$8, %esp	/ ,
	pushl	$3	/ 
	pushl	$99	/ 
	call	terminal_putchar_color	/ 
/  src/kernel.c:14:     terminal_putchar('t');
	movl	$116, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:15:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:18:     kprintf("%i", algebraic_sign(0));
	movl	$0, (%esp)	/ ,
	call	algebraic_sign	/ 
/  src/kernel.c:18:     kprintf("%i", algebraic_sign(0));
	addl	$8, %esp	/ ,
	movsbl	%al, %eax	/  tmp100, _1
	pushl	%eax	/  _1
	pushl	$.LC3	/ 
	call	kprintf	/ 
/  src/kernel.c:19:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:20:     kprintf("%i", ksignbit(1));
	movl	$1, (%esp)	/ ,
	call	ksignbit	/ 
/  src/kernel.c:20:     kprintf("%i", ksignbit(1));
	addl	$8, %esp	/ ,
	movsbl	%al, %eax	/  tmp101, _3
	pushl	%eax	/  _3
	pushl	$.LC3	/ 
	call	kprintf	/ 
/  src/kernel.c:21:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:22:     kprintf("%i", ksignbit(2));
	movl	$2, (%esp)	/ ,
	call	ksignbit	/ 
/  src/kernel.c:22:     kprintf("%i", ksignbit(2));
	addl	$8, %esp	/ ,
	movsbl	%al, %eax	/  tmp102, _5
	pushl	%eax	/  _5
	pushl	$.LC3	/ 
	call	kprintf	/ 
/  src/kernel.c:23:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:24:     kprintf("%i", ksignbit(-3));
	movl	$-3, (%esp)	/ ,
	call	ksignbit	/ 
/  src/kernel.c:24:     kprintf("%i", ksignbit(-3));
	addl	$8, %esp	/ ,
	movsbl	%al, %eax	/  tmp103, _7
	pushl	%eax	/  _7
	pushl	$.LC3	/ 
	call	kprintf	/ 
/  src/kernel.c:25:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:27:     kprintf("%i", ksignbit(3));
	movl	$3, (%esp)	/ ,
	call	ksignbit	/ 
/  src/kernel.c:27:     kprintf("%i", ksignbit(3));
	addl	$8, %esp	/ ,
	movsbl	%al, %eax	/  tmp104, _9
	pushl	%eax	/  _9
	pushl	$.LC3	/ 
	call	kprintf	/ 
/  src/kernel.c:28:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:30:     kprintf("%i", ksignbit(13));
	movl	$13, (%esp)	/ ,
	call	ksignbit	/ 
/  src/kernel.c:30:     kprintf("%i", ksignbit(13));
	addl	$8, %esp	/ ,
	movsbl	%al, %eax	/  tmp105, _11
	pushl	%eax	/  _11
	pushl	$.LC3	/ 
	call	kprintf	/ 
/  src/kernel.c:31:     terminal_putchar('\n');
	movl	$10, (%esp)	/ ,
	call	terminal_putchar	/ 
/  src/kernel.c:36:     kassert_void(1==2);
	addl	$12, %esp	/ ,
	pushl	$36	/ 
	pushl	$.LC4	/ 
	pushl	$.LC5	/ 
