...
void terminal_context_setcolor(enum vga_color color);
void terminal_context_resetcolor(void);
void terminal_context_putentryat(char c, enum vga_color color, size_t x, size_t y);
void terminal_context_putchar(char c);
void terminal_context_putchar_color(char c, enum vga_color color);
void terminal_context_swapchar(char c);
void terminal_context_swapchar_color(char c, enum vga_color color);
void terminal_context_write(const char* text, size_t size);
void terminal_context_writestring(const char* text);
void terminal_context_write_color(const char* text, size_t size, enum vga_color color);
void terminal_context_writestring_color(const char* text, enum vga_color color);
