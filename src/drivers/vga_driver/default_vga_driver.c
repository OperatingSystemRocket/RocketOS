...
void terminal_context_setcolor(const enum vga_color color) {
...
void terminal_context_putentryat(const char c, const enum vga_color color, const size_t x, const size_t y) {
...
void terminal_context_putchar_color(const char c, const enum vga_color color) {
...
void terminal_context_swapchar_color(const char c, const enum vga_color color) {
...
void terminal_context_write_color(const char *const text, const size_t size, const enum vga_color color) {
    terminal_write_color(&default_vga_driver_context, text, size, color);
}
void terminal_context_writestring_color(const char const* text, const enum vga_color color) {
